        ...
        if (isOpen) {
            ...
            api.get('/admin/students')
                ...
                .catch(() => {
                    ...
                    setStudents([
                        { id: '1', first_name: 'Alice', last_name: 'Johnson', email: 'alice@example.com', grade: '5' },
                        { id: '2', first_name: 'Bob', last_name: 'Smith', email: 'bob@example.com', grade: '8' },
                        { id: '3', first_name: 'Charlie', last_name: 'Brown', email: 'charlie@example.com', grade: '10' },
                    ]);
                })
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white dark:bg-gray-900 rounded-2xl w-full max-w-2xl max-h-[80vh] overflow-hidden flex flex-col shadow-2xl border border-white/10">
                <div className="p-6 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center bg-gray-50 dark:bg-gray-800/50">
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Registered Students</h2>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead className="bg-gray-100 dark:bg-gray-800 sticky top-0">
                                <tr>
                                    ...
                                    <th className="p-4 text-xs font-bold text-gray-500 uppercase">Grade</th>
